	...
	<div class="wrapper">
						...
						<li class="dropdown user user-menu"><a href="#"
							...
							<ul class="dropdown-menu">
								...
								<li class="user-footer">
									<div class="pull-left">
										<a href="InfoManager?id=${teacher}" class="btn btn-default btn-flat">Manager</a>
									</div>
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					布置作业 <small>Setting Homework</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="teacher"><i class="fa fa-dashboard"></i>
							Home</a></li>					
					<li class="active">SettingHomework</li>
				</ol>
			</section>
			...
			<div class="box box-info" style="width:800px;">
					...
					<!-- /.box-header -->
					<div class="box-body">
						<form role="form" action="homeworkSetting" method="post">
							...
							<!-- text input -->
							<div class="form-group">
								<label>作业名称</label> <input type="text" class="form-control"
									name="rname" placeholder="请填写作业名称">
							</div>
							
							<div class="form-group">
								<label>资源类型</label> <input type="text" class="form-control" 
									name="rtype" value="作业" readonly>			
							</div>
							...
							<div class="form-group">
								...
								<textarea class="form-control" name="cbrief" rows="4"
									placeholder="请对作业要求进行描述"></textarea>
							</div>
