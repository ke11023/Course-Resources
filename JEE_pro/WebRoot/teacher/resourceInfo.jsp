	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					资源管理 <small>Resource Manage</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="teacher"><i class="fa fa-dashboard"></i>
							Home</a></li>					
					<li class="active">ResourceManage</li>
				</ol>
			</section>
					...
					<div class="col-xs-12">
						<div class="box">
							<div class="box-header">
								<h3 class="box-title">CourseInfo Table</h3>
							...
							<div class="box-body">
								<table id="example" class="table table-bordered table-hover">
									...
									<tbody>
										<c:forEach var="info" items="${resource}">
											<tr role="row" class="odd">
												<td><a href="resourceDetail?route=${info.rroute}">${info.rname}</a></td>
												<%-- <td>${info.course.cname}</td> --%>
												<td>${info.rtype}</td>
												<td>${info.rtime }</td>
												<td>${info.rdescription}</td>
												<td><a href="deleteResource?rid=${info.rid}">delete</a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
