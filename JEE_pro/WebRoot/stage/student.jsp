...
======================================= -->
			...
			<div class="page_title2">
				<div class="container">
					...
					<div class="pagenation">
						&nbsp;<a href="index.jsp">Home</a> <i>/</i>Student
					</div>
			...
			<div class="container">
				...
				<div class="content_fullwidth">
					...
					<ul class="tabs3">
						<li><a href="#example-3-tab-1" target="_self">个人信息</a></li>
					</ul>
					...
					<div class="tabs-content3">
						...
						<div id="example-3-tab-1" class="tabs-panel3">
							...
							<h4>学号：${studentInfo.sid}</h4><br>
							<h4>姓名：${studentInfo.sname}</h4><br>
							<h4>性别：${studentInfo.ssex}</h4><br>
							<h4>年龄：${studentInfo.sage}</h4><br>
							<br>
							<a href="StudentInfoManager">修改</a>
				...
				<div class="one_full">
					...
					<ul class="tabs">
						<li><a href="#demo-tab-1" target="_self"><span id="click">未查看作业</span></a></li>
						<li><a href="#demo-tab-2" target="_self">历史作业</a></li>
					</ul>
									...
									<tbody>
										<c:forEach var="homework" items="${homework}">
											<tr role="row" class="odd">											
												<%-- <td>${homework.cid}</td> --%>
												<td>${homework.mesdescription}</td>
												<td><a href="homeworkDetail?route=${homework.mesroute}&mesid=${homework.mesid}">detail</a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
								...
								<table id="history" class="table table-bordered table-hover">
									...
									<tbody>
										<c:forEach var="history" items="${history}">
											<tr role="row" class="odd">											
												<%-- <td>${history.cid}</td> --%>
												<td>${history.mesdescription}</td>
												<td><a href="homeworkDetail?route=${history.mesroute}&mesid=${history.mesid}">detail</a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
