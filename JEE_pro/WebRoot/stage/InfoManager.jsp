...
======================================= -->
			...
			<div class="comment_form">
						...
						<form role="form" action="StudentInfoEdit">
							<!-- text input -->							
							<input type="text" class="comment_input_bg" name="id" id="id"
									value="${studentInfo.sid}" readonly>
							<label for="id">学号</label>
							<input type="text" class="comment_input_bg" name="name" id="name"
									value="${studentInfo.sname}" >
							<label for="name">姓名</label>
							<input type="text" class="comment_input_bg" name="pwd" id="pwd"
									value="${studentInfo.spwd}">
							<label for="pwd">密码</label>
							<input type="text" class="comment_input_bg" name="sex" id="sex"
									value="${studentInfo.ssex}">
							<label for="sex">性别</label>
							<input type="text" class="comment_input_bg" name="age" id="age"
									value="${studentInfo.sage}">
