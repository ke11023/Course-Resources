	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					学生信息修改 <small>Student Edit</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="home"><i class="fa fa-dashboard"></i>
							Home</a></li>					
					<li class="active">StudentEdit</li>
				</ol>
			</section>
			...
			<section class="content">
					...
					<!-- /.box-header -->
					<div class="box-body">
						<form role="form" action="student_edit">
							<!-- text input -->
							...
							<div class="form-group" >
								<label>学生姓名</label> <input type="text" class="form-control" name="name"
									value="${student_name}">
							</div>
							<div class="form-group">
