	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					添加课程 <small>Add Course</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="home"><i class="fa fa-dashboard"></i>
							Home</a></li>					
					<li class="active">addCourse</li>
				</ol>
			</section>
			...
			<section class="content">
				...
				<div class="box box-info">
					...
					<!-- /.box-header -->
					<div class="box-body">
						<form role="form" action="addcourse">
							<!-- text input -->
							<div class="form-group" >
								<label>课程号</label> <input type="text" class="form-control" name="cid"
									placeholder="请输入课程编号">
							</div>
							<div class="form-group">
								<label>课程名</label> <input type="text" class="form-control" name="cname"
									placeholder="请输入课程名">
							</div>

							<div class="form-group" >
								<label>授课教师</label> <select class="form-control" name="cdepaetment">
									<option>计算机学院</option>
									<option>经管学院</option>
									<option>电气学院</option>
									<option>数理学院</option>
							...
							<div class="form-group">
								<label>课程简介</label>
								<textarea class="form-control" name="cbrief" rows="3" placeholder="请对课程进行介绍"></textarea>
							</div>

							<!-- select -->
							<div class="form-group" >
								<label>授课教师</label> <select class="form-control" name="tid">
									<c:forEach var="info" items="${teacher}">
											<option>${info.tid}</option>
									</c:forEach>
								</select>
							</div>
