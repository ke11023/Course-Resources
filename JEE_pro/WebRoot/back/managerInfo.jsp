	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					管理员信息 <small>Manager Information</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="home"><i class="fa fa-dashboard"></i>
							Home</a></li>
					<li class="active">ManagerInfo</li>
				</ol>
			</section>
					...
					<div class="col-xs-12">
						<div class="box">
							<div class="box-header">
								<h3 class="box-title">ManagerInfo Table</h3>
							</div>
							<table id="example" class="table table-bordered table-hover"
								...
								<tbody>
									<c:forEach var="info" items="${manager}">
										<tr role="row" class="odd">
											<td >${info.mid}</td>
											<td >${info.mpwd}</td>
											<td><a href="managerEdit?id=${info.mid}">edit</a></td>
										</tr>
									</c:forEach>
								</tbody>
