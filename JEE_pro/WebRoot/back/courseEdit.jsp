	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					课程信息修改 <small>Course Edit</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="home"><i class="fa fa-dashboard"></i>
							Home</a></li>					
					<li class="active">CourseEdit</li>
				</ol>
			</section>
			...
			<section class="content">
					...
					<!-- /.box-header -->
					<div class="box-body">
						<form role="form" action="course_edit">
							<!-- text input -->
							
							<div class="form-group" >
								<label>课号</label> <input type="text" class="form-control" name="id"
									value="${id}" readonly>
							</div>
							<div class="form-group">
								<label>课名</label> <input type="text" class="form-control" name="name"
									value="${course_name}">
							</div>
							
							<div class="form-group" >
								<label>学院</label> <select class="form-control" name="cdepaetment">
									<option>计算机学院</option>
									<option>经管学院</option>
									<option>电气学院</option>
									<option>数理学院</option>
							...
							<div class="form-group">
								<label>授课教师</label> <input type="text" class="form-control" name="tid"
									value="${tid}">
							</div>
							<div class="form-group">
								<label>课程描述</label> <input type="text" class="form-control" name="brief"
									value="${brief}">
							</div>
