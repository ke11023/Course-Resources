	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					学生信息 <small>Student Information</small>
				</h1>
				<ol class="breadcrumb">
					...
					<div class="col-xs-12">
						<div class="box">
							<div class="box-header">
								<h3 class="box-title">StudentInfo Table</h3>
							...
							<div class="box-body">
								<table id="example" class="table table-bordered table-hover">
									...
									<tbody>
										<c:forEach var="info" items="${student}">
											<tr role="row" class="odd">
												<td id="mid">${info.sid}</td>
												<td id="mpwd">${info.spwd}</td>
												<td>${info.sname}</td>
												<td>${info.sage}</td>
												<td>${info.ssex }</td>
												<td>${info.status }</td>
												<td><a href="studentEdit?id=${info.sid}">edit</a>&nbsp;
												<a href="deleteStudent?id=${info.sid}">delete</a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
