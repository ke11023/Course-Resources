	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					教师信息 <small>Teacher Information</small>
				</h1>
				<ol class="breadcrumb">
					...
					<div class="col-xs-12">
						<div class="box">
							<div class="box-header">
								<h3 class="box-title">TeacherInfo Table</h3>
									...
									<tbody>
										<c:forEach var="info" items="${teacher}">
											<tr role="row" class="odd">
												...
												<td>${info.tsex}</td>
												<td>${info.tphone}</td>
												<td><a href="teacherEdit?id=${info.tid}">edit</a>&nbsp;
												<a href="deleteTeacher?id=${info.tid}">delete</a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
