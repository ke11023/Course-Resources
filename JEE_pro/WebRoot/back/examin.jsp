	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					注册审批 <small>Register Examin</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="home"><i class="fa fa-dashboard"></i>
							Home</a></li>
					<li class="active">RegisterExamin</li>
				</ol>
			</section>
					...
					<div class="col-xs-12">
						<div class="box">
							<div class="box-header">
								<h3 class="box-title">RegisterInfo Table</h3>
							</div>
							<table id="example" class="table table-bordered table-hover"
								...
								<tbody>
									<c:forEach var="info" items="${examin}">
										<tr role="row" class="odd">
											<td >${info.sid}</td>
											<td >${info.spwd}</td>
											<td><a href="examin?id=${info.sid}" >审批通过</a></td>
										</tr>
									</c:forEach>
								</tbody>
